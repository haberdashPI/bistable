...
for i in `seq $S $K $N`; do
  echo "sbatch projects/bistable/models/little/count_lengths/run_count_lengths.sh $i \
    ...
    --params projects/bistable/models/little/count_lengths/params_2018-07-26.feather \
    --settings projects/bistable/models/little/count_lengths/settings_2018-07-02.toml \
    -d /scratch/groups/melhila1/dlittle/bistable_threshold_003/data/ \
    -l /scratch/groups/melhila1/dlittle/bistable_threshold_003/logs/result_${i}.log"
done
